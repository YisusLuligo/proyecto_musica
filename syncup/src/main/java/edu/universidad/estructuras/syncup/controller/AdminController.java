...
public class AdminController {
    ...
    public void volverInicio() {
        try { Router.goTo("login.fxml", "Iniciar sesión"); } catch (Exception ignored) {}
    }

    @FXML
    public void abrirBiblioteca() {
        try { Router.goTo("biblioteca.fxml", "Biblioteca"); } catch (Exception ignored) {}
    }
    ...
    private class AccionesCellCancion extends TableCell<CancionRow, String> {
        ...
        AccionesCellCancion() {
            ...
            play.setOnAction(e -> {
                try { Router.goTo("reproductor.fxml", "Reproductor"); }
    ...
    private class AccionesCellUsuario extends TableCell<UsuarioRow, String> {
        ...
        AccionesCellUsuario() {
            ...
            manage.setOnAction(e -> {
                ...
                try { Router.goTo("perfil.fxml", "Perfil"); } catch (Exception ignored) {}
            });
